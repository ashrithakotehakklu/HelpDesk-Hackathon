...
const DashboardAdmin = () => {
  ...
  const loadTicket = async () => {
    ...
    console.log(result);
    setTicket(result.USER_DATA.TICKETS_RAISED_BY_USER);
    console.log(ticket);
    setassignedTo(result.USER_DATA.TICKETS_ASSIGNED_TO_USER);
  ...
  return (
    <div>
      ...
      <Link className="btn btn-dark create-btn m-2" to="/viewTicket">View All Ticket</Link>      
